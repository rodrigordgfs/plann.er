        ...
        <div className="space-y-4">
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              ...
              <button
                onClick={() => handleConfirmTripModal(true)}
                className="bg-lime-300 hover:bg-lime-400 transition-all text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2"
              >
                Confirmar viagem
                <ArrowRight className="size-5" />
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            >
              ...
              <button
                ...
                className="w-full bg-lime-300 justify-center hover:bg-lime-400 transition-all text-lime-950 rounded-lg px-5 h-11 font-medium flex items-center gap-2"
              >
